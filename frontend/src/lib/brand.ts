export const PRODUCT_NAME = "AlgoMentor";
export const PRODUCT_TAGLINE = "Graph-guided big-tech interview prep";
export const PRODUCT_DESCRIPTION =
  "Master the patterns behind big-tech coding interviews — prerequisite map, community notes, and AI hints.";

export const KNOWLEDGE_BASE_REPO =
